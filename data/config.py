...
SEMI_AUTOMATIC_APPROVE_LINK = True # if True - allow to manual paste approve link from email to cli
# If you have possibility to forward all approve mails to single IMAP address:
SINGLE_IMAP_ACCOUNT = True # usage "name@domain.com:password"
...
CLAIM_REWARDS_ONLY = True  # claim tiers rewards only (https://app.getgrass.io/dashboard/referral-program)
